...
LOG_DIR="/c/Users/Freja/Desktop/KEA/Semester_3/Teknologi/logs"
ERROR_PATTERNS=("ERROR" "FATAL" "CRITICAL")
REPORT_FILE="/c/Users/Freja/Desktop/KEA/Semester_3/Teknologi/logs/log_analysis_report.txt"
...
echo -e "\n" >> "$REPORT_FILE"
    ...
    for PATTERN in ${ERROR_PATTERNS[@]}; do
        ...
        echo -e "\nSearching for $PATTERN logs found in $LOG_FILE file" >> "$REPORT_FILE"
